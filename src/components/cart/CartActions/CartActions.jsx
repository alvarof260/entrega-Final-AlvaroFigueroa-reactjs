...
export const CartActions = ({totalMount, cleanCart}) => {
    ...
    return(
        <div className="flex flex-row w-[950px] justify-between">
            ...
            <div className='flex flex-row items-center flex-grow gap-2'>
                <button 
                className='border rounded p-2 w-96 flex justify-center items-center gap-1 hover:bg-mint hover:text-white  transition-all ease-linear duration-500'
                >
                ...
                <div className='w-full text-center' >
                    ...
                    <span className='text-center'>${Number(totalMount()).toLocaleString()}</span>
                </div>
            </div>
        </div>
    )
